...
class CCMSToggleButtonn extends StatefulWidget {
  const CCMSToggleButtonn({Key? key}) : super(key: key);

  @override
  _CCMSToggleButtonnState createState() => _CCMSToggleButtonnState();
}
...
class _CCMSToggleButtonnState extends State<CCMSToggleButtonn> {
  late double xAlign;
